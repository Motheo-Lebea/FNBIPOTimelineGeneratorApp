...
public class App extends JFrame {
    ...
    private void createUI() {
        setTitle("FNB IPO Timeline Generator");
        ...
        headerPanel.setBackground(new Color(200, 160, 130));
        JLabel titleLabel = new JLabel("FNB IPO Timeline Generator");
    ...
    private void generateTimeline(ActionEvent e) {
        try {
            ...
            List<FNBIPOTimelineGenerator.IPOPhase> timeline =
                    FNBIPOTimelineGenerator.generateTimeline(ipoDate);

            Object[][] data = new Object[timeline.size()][3];
            for(int i = 0; i < timeline.size(); i++) {
                FNBIPOTimelineGenerator.IPOPhase phase = timeline.get(i);
